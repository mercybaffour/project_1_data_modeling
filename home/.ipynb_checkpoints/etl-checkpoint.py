...
def process_log_file(cur, filepath):
    ...
    time_data = []
    time_data.extend((t, hour.astype(int), day.astype(int), week_of_year.astype(int), month.astype(int), year.astype(int), weekday.astype(int)))
    column_labels = ["timestamp", "timestamp_hour", "timestamp_day", "timestamp_weekofyear", "timestamp_month", "timestamp_year", "timestamp_weekday"]
